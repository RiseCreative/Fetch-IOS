...
- (void)startObserving
{
    ...
    //frame.origin.x += scroll.contentOffset.x;

    frame.size.width = screenRect.size.width - 50;
    frame.size.height = 200;
    self.suggestionView.frame = frame;
    self.suggestionView.layer.borderWidth = 0;
    self.suggestionView.layer.borderColor = [UIColor redColor].CGColor;
...
- (void)configureSuggestionView
{
    ...
    suggestionView.layer.borderColor = [UIColor colorWithRed:31/255.0f green:151/255.0f blue:248/255.0f alpha:1.0f].CGColor;
    suggestionView.layer.borderWidth = 0;
...
- (void)setBorderStyleRoundedRect
{
    ...
    [self.suggestionView.layer setBorderWidth:0];
...
- (void)setBorderStyleNone
{
    ...
    [self.suggestionView.layer setBorderWidth:0];
    [self.suggestionView.layer setBorderColor:[UIColor lightGrayColor].CGColor];
    [self.suggestionView setBackgroundColor:[UIColor clearColor]];
